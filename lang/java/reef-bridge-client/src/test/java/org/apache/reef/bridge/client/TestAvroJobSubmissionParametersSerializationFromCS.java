...
/**
 * Created by anchung on 11/12/2015.
 */
public final class TestAvroJobSubmissionParametersSerializationFromCS {
  ...
  public void testAvroYarnClusterParametersDeserialization() throws IOException {
    // YarnClusterSubmissionFromCS.readYarnClusterSubmissionFromCSFromInputStream();
  }

  @Test
  public void testAvroYarnParametersDeserialization() throws IOException {
    // YarnBootstrapDriverConfigGenerator.readYarnJobSubmissionParametersFromInputStream();
  }
  ...
  @Test
  public void testYarnBootstrapDriverConfigGenerator() {
